...
public class PrintsetActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				i.putExtra("Ivno", new DecimalFormat("000").format(ivno));
	...
	private void initializeLogic() {
		...
		ivno = Double.parseDouble(new DecimalFormat("000").format(Double.parseDouble(getIntent().getStringExtra("Ivno"))));
		textview2.setText("Invoice no. ".concat(String.valueOf((long)(ivno))));
		if (code.equals("09")) {
		...
		qr = String.valueOf((long)(SketchwareUtil.getRandom((int)(0), (int)(9)))).concat(String.valueOf((long)(ivno)).concat(new SimpleDateFormat("ddMM").format(cal.getTime()).concat(new SimpleDateFormat("yyyy").format(cal.getTime()).substring((int)(2), (int)(4)))));
